...
public class UserGUI : MonoBehaviour {
    ...
    private void OnGUI()
    {
        ...
        {
            GUI.Label(new Rect(Screen.width / 2 - 60, Screen.width / 2 - 320, 100, 100), "鼠标点击射箭", over_style);
            GUI.Label(new Rect(Screen.width / 2 - 70, Screen.width / 2 - 280, 400, 100), "WSAD/方向键控制弓箭移动", text_style);

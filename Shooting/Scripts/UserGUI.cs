...
public class UserGUI : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        {
            GUI.Label(new Rect(Screen.width / 2 - 60, Screen.width / 2 - 320, 100, 100), "WSAD或者方向键控制弓箭移动", text_style);
            GUI.Label(new Rect(Screen.width / 2 - 150, Screen.width / 2 - 220, 400, 100), "鼠标点击射箭", text_style);
